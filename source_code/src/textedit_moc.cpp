...
static const char qt_meta_stringdata_TextEdit[] = {
    "TextEdit\0\0pos\0dragged(QPoint)\0"
    "sizeDragged(QPoint)\0removeTextEdit()\0"
    "removeThisTextEdit()\0"
};
...
void TextEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->sizeDragged((*reinterpret_cast< const QPoint(*)>(_a[1]))); break;
        case 2: _t->removeTextEdit(); break;
        case 3: _t->removeThisTextEdit(); break;
        default: ;
        }
    }
}
...
const QMetaObject TextEdit::staticMetaObject = {
    { &Box::staticMetaObject, qt_meta_stringdata_TextEdit,
...
// SIGNAL 0
void TextEdit::dragged(QPoint _t1)
{
...
// SIGNAL 1
void TextEdit::sizeDragged(const QPoint & _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
